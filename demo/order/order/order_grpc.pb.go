...
const (
	...
	Order_UpdateOrderByGoodsNo_FullMethodName   = "/order.Order/UpdateOrderByGoodsNo"
...
func (c *orderClient) UpdateOrderByGoodsNo(ctx context.Context, in *UpdateOrderByGoodsNoRequest, opts ...grpc.CallOption) (*UpdateOrderByGoodsNoResponse, error) {
	out := new(UpdateOrderByGoodsNoResponse)
	err := c.cc.Invoke(ctx, Order_UpdateOrderByGoodsNo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	UpdateOrderByGoodsNo(context.Context, *UpdateOrderByGoodsNoRequest) (*UpdateOrderByGoodsNoResponse, error)
...
func (UnimplementedOrderServer) UpdateOrderByGoodsNo(context.Context, *UpdateOrderByGoodsNoRequest) (*UpdateOrderByGoodsNoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateOrderByGoodsNo not implemented")
}
...
func _Order_UpdateOrderByGoodsNo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateOrderByGoodsNoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).UpdateOrderByGoodsNo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Order_UpdateOrderByGoodsNo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).UpdateOrderByGoodsNo(ctx, req.(*UpdateOrderByGoodsNoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Order_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateOrderByGoodsNo",
			Handler:    _Order_UpdateOrderByGoodsNo_Handler,
		},
		{
