...
func (s *OrderServer) UpdateOrderByGoodsNo(ctx context.Context, in *order.UpdateOrderByGoodsNoRequest) (*order.UpdateOrderByGoodsNoResponse, error) {
	l := logic.NewUpdateOrderByGoodsNoLogic(ctx, s.svcCtx)
	return l.UpdateOrderByGoodsNo(in)
}
